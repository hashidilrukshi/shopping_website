...
const JewelryPage = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      price: 25000,
      originalPrice: null,
      image: "https://images.unsplash.com/photo-1603561596112-6a132309c3d2?w=400&h=400&fit=crop",
      category: "rings",
      rating: 4.9,
      reviews: 203,
      isNew: true,
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Jewelry Collection</h1>
              <p className="text-gray-600">Discover exquisite jewelry pieces to complement your style</p>
            </div>
